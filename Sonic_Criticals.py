...
class Criticals3:
    ...
    def __init__(self, sp_smfiles, suca_files, dirs_not_to_be_included, out_dir):
    ...
    def analyze_wind_fls(self, v_n_arr, append0=False, append1=False):
        '''
...
class Criticals_GA:
    ...
    def __init__(self, ga_smfiles, out_dir, plot_dir, dirs_not_to_be_included):
    ...
    def analyze_ga_sm_fls(self, depth, add_sonic_vals, show_plot):
        ...
        def crop_ends(x, y):
            ...
            while non_monotonic:
                ...
                if y_mon[-1] > y_mon[-2] or y_mon[-2] > y_mon[-3]:
                    y_mon = y_mon[:-1]
                    x_mon = x_mon[:-1]
                    # print(x_mon[-1], y_mon[-1])
                else:
        ...
        def cross(mdot, r1, u1, r2, u2, mdot_maxs, u_ot_t = 'u'):
            ...
            f2 = interpolate.InterpolatedUnivariateSpline(u2, r2) # cropping is done to cut the high mdot prob
            r2_grid = f2(u_grid)
        ...
        tablehead = '{} {} {} {} {} {}'\
            .format('log(L)', 'M(Msun)', 'Yc', 'mdot', 'r-sp', 't-sp')
        # log(L)  M(Msun)     Yc     Ys        mdot     r-sp     t-sp
    ...
    def save(self, depth, add_sonic_vals, show_plot, use_wind_fls = True):
        ...
        fname = create_file_name('SP')

        head = ga_head
        table = ga_table
        print('\n FILE: {} | SAVED IN: {} | ONLY sm.data FILES USED'.format(fname, 'SP'))
